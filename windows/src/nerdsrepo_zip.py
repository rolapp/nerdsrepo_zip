...
config_file = os.path.join(_home + '/nerdsrepo_config.ini')
...
class Menu(tk.Frame):
    ...
    def __init__(self,master, **kwargs):
        ...
        self.menubar.add_command(label="Beenden", command=master.destroy)
        self.menubar.add_command(label="Hilfe", command=self.Help)
